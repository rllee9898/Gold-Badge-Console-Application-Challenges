...
namespace _02_ClaimsUI
{
    public class ProgramUI
    {
        ...
        private void ShowAllItems()
        {
            ...
            Console.WriteLine("{0,15} {1,15} {2,15} {3,15} {4,15} {5,15} {6,15}", "Claim ID", "Claim Type", "Description", "Amount", "Date Of Incident", "Date Of Claim", "IsValid");
        ...
        private void DisplayItemsTwo(Claims claims)
        {
            Console.WriteLine("{0,15} {1,15} {2,15} {3,15} {4,15} {5,15} {6,15}", claims.ClaimID, claims.ClaimType, claims.Description, claims.ClaimAmount, claims.DateOfIncident, claims.DateOfClaim, claims.IsValid);
        }
